...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
      <img src="pic1.png" style="width:100%; height: 350px;">
      <div class = "text" style="color: white; font-weight: 400;">Update on Remote Course Delivery in Computer Science &nbsp  <a href = "#" style="text-decoration: none; color: red;" onclick = "moveTo('remotelearning.html')">see more ...</a>
      </div>
    </div>
  
    <div class="mySlides fade">
      <img src="lab.png" style="width:100%; height: 350px;">
      <div class="text">Update on Remote Course Delivery in Computer Science &nbsp  <a href = "#" style="text-decoration: none; color: red;" onclick = "moveTo('remotelearning.html')">see more ...</a>
      </div>
    </div>
      ...
      <!----------------------------------- New div ------------------------------------->
            ...
            <div class="rowsecond">
                ...
                <div class="column">
                    ...
                    <div style="background-image: url('usenow.png')  ; height: 60px;">
                        <p style="font-size: 20px; color: red; padding-left: 10px; padding-top: 10px;">
                            latest@cs
                            <a href="#" onclick = "moveTo('news.php')" style="font-size: 12px; text-decoration: none;color: rgb(255, 255, 255);">more...</a>
                        </p>
                    </div>
                    ...
                    $conn = mysqli_connect("localhost","cs307-group23","pyjHPQCUbdkBWFT4","cs307-group23-DB");  /* database name : news */
                ...
                <div class="column-mid">
                    <div style="background-image: url('trottier.png') ; height: 60px;">
                ...
                <div class="column">
                    ...
                    <div style="background-image: url('trottier2.png'); height: 60px;">
